...
router.get("/PromotionHistory", async (req, res) => {
  try {
    ...
    console.log("LOGON_USER_PromotionHistory:", logonUser);
    console.log("Extracted devId_PromotionHistory:", devId);
    ...
    res.sendFile(path.join(__dirname, "../public/PromotionHistory.html"));
  } catch (error) {
    console.error("Error in /PromotionHistory route:", error);
